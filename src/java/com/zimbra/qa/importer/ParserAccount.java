...
public class ParserAccount extends ParserBase {
	...
	private static Logger mLog = Logger.getLogger(ParserAccount.class.getName());
	...
	public HashMap<String, Object> parseInputFile() throws IOException {
		...
		// TODO:
		// Why does zimbraZimletAvailableZimlets throw an exception: invalid attr type: zimbraZimletAvailableZimlets [Ljava.lang.Object;

		// TODO:
		// Why does zimbraPrefStandardClientAccessilbityMode throw an exception: createAccount invalid attr name: [LDAP: error code 17 - zimbraPrefStandardClientAccessilbityMode: attribute type undefined]
		...
		try{
			...
			// BEGIN: zimbraQuotaWarnMessage - the default message contains the ":" character, which breaks the ParserBase.parseInputFile() method
			...
			// BEGIN: zimbraInterceptSubject - the default message contains the ":" character, which breaks the ParserBase.parseInputFile() method
			...
			// BEGIN: zimbraNewMailNotificationBody - the default message contains the ":" character, which breaks the ParserBase.parseInputFile() method
			...
			while ( (line = rafReader.readLine()) != null ) {
				...
				if ( line.startsWith("zimbraNewMailNotificationBody: ") ) {
					attrs.put("zimbraNewMailNotificationBody", line.substring("zimbraNewMailNotificationBody: ".length()));
					break;
				}
			}		
