...
public class ExtensionCustomAuthQA implements ZimbraExtension {
    ...
    public class CustomAuthQA extends ZimbraCustomAuth {
        /*
         * Method invoked by the framework to handle authentication requests. A custom
         * auth implementation must implement this abstract method.
         * 
         * @param account: The account object of the principal to be authenticated all
         * attributes of the account can be retrieved from this object.
         * 
         * @param password: Clear-text password.
         * 
         * @param context: Map containing context information. A list of context data is
         * defined in com.zimbra.cs.account.AuthContext
         * 
         * @param args: Arguments specified in the zimbraAuthMech attribute
         * 
         * @return Returning from this function indicating the authentication has
         * succeeded.
         * 
         * @throws Exception. If authentication failed, an Exception should be thrown.
         */
        public void authenticate(Account account, String password, Map<String, Object> authCtxt, List<String> args)
                throws Exception {
            ...
            if (password.equalsIgnoreCase("AUTH_FAILED")) {
                throw AuthFailedServiceException.AUTH_FAILED(account.getName(), AuthMechanism.namePassedIn(authCtxt),
                        (Throwable) null);
            }
