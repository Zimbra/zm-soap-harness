...
public class PstImportTest extends Test {
    ...
    public boolean executeTest() throws HarnessException {
        ...
        // If harnessWizardPath is not set, then the perl script will download from the
        // server
        ...
        try {
            ...
            throw new HarnessException("Cannot find pst import perl script " + mapiRoot + File.separator + fPerlScript,
                    e);
        }
