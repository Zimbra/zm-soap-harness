...
public class zDesktopAcctTest extends Test {
    ...
    protected boolean doAdd(Element element) throws HarnessException {
        ...
        try {
            StringRequestEntity entity = new StringRequestEntity(sb.toString(), "application/x-www-form-urlencoded",
                    null);
    ...
    private static String validAttributes = "verb accountId accountFlavor " + "accountName email password host port "
