...
public class TestProperties {
    ...
    // Read the multinode info file and update DynamicProps with multi server's
    // address
    ...
    /*
     * UpdateMachineProperties function will read the property files of the machine
     * and put the server Properties object into a map
     * 
     * 
     */
    ...
    public String getProperty(String key, String defaultValue) {
        ...
        if (refServerProperties != null) {
            ...
            } else if (key.equals("server.zimbraAccount") || key.equals("server.zimbraMail")
                    || key.equals("caldav.server") || key.equals("server.restServlet")) {
...
//	}
    ...
    public void clearProperties() {
        ...
        // writeProperties(); // Clear the properties file, to
    }
