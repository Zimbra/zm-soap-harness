...
public abstract class Test extends AbsTest {
    ...
    protected static Logger mLog = LogManager.getLogger(Test.class.getName());
    ...
    protected String getDetails() {
        ...
        details.append(lpadz(mTestNum + "", 4) + " - " + mTimeStamp.toString()
                + (mReference == null ? "" : " - " + mReference.toString()) + "\n");
     ...
     * @return
     */
    protected static String pad(String s, int width, boolean withZero, boolean left) {
    ...
    static public boolean checkDepends(Test test) throws HarnessException {
        ...
        if (depends != null) {
            for (int i = 0; i < depends.length; i++) {
                ...
                if (t == null)
                    throw new HarnessException("test (id=" + test.getId() + ") depends on test (id=" + depends[i]
    ...
    protected int systemCommand(String command, File dir) throws HarnessException {
        ...
        try {
            ...
            mSetupDetails = "exec: " + cmd[0] + " " + cmd[1] + " " + cmd[2]
                    + ((dir == null) ? "" : dir.getCanonicalFile());
