...
public class StafTaskTest extends Test {
    ...
    protected boolean executeStaf() throws HarnessException {
        ...
        try {
            ...
            try {
                StafRequest.append("STAF ").append(StafServer).append(" ").append(StafService).append(" ")
                        .append(StafParams).append(LineSeparator);
    ...
    protected boolean executeTest() throws HarnessException {
        ...
        // Bug 37055
        // If mailboxdct was used, we need to wait a while to let the server fully come
        // up
