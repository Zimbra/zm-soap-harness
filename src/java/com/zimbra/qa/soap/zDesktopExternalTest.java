    ...
    protected boolean setUri() throws HarnessException {
        ...
        if (server != null) {
            if (mNamespace.equals(AdminConstants.NAMESPACE_STR)) {
                ...
                String httpPath = TestProperties.testProperties.getProperty("zexternal.soapservice.admin.path",
                        "service/admin/soap/");
                ...
                String httpPath = TestProperties.testProperties.getProperty("zexternal.soapservice.soap.path",
                        "service/soap/");
                uriString = httpMode + "://" + server + ":" + httpPort + "/" + httpPath;
            }
        } else {
            uriString = TestProperties.testProperties.getProperty("zexternal.uri",
