...
java -Xmx700m -classpath ".:${QADIR}/classes:${JARDIR}/log4j-core-2.17.1.jar:${JARDIR}/log4j-api-2.17.1.jar:${JARDIR}/guava-r07.jar:${JARDIR}/commons-codec-1.2.jar:${JARDIR}/zimbrastore.jar:${JARDIR}/commons-cli-1.0.jar:${JARDIR}/commons-httpclient-2.0.1.jar:${JARDIR}/commons-logging.jar:${JARDIR}/dom4j-1.5.jar:${JARDIR}/PDFBox-0.6.5.jar:${JARDIR}/activation.jar:${JARDIR}/commons-cli-1.0.jar:${JARDIR}/commons-dbcp-1.1.jar:${JARDIR}/commons-fileupload-1.0.jar:${JARDIR}/commons-pool-1.1.jar:${JARDIR}/jaxen-1.1-beta-3.jar:${JARDIR}/jug-1.1.2.jar:${JARDIR}/javamail-1.4.3.jar:${JARDIR}/mysql-connector-java-3.0.14-production-bin.jar"  -Dlog4j.configuration=/opt/zimbra/jakarta-tomcat-5.0.28/webapps/service/WEB-INF/classes/log4j.properties  com.zimbra.qa.load.SoapGenerator -f $1 -u $2 -d $4 -n $3 -s $5 -t $6 
