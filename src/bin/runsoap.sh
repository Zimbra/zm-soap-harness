...
# Java Settings
#
ZIMBRA_CLASS_PATH="$QA_ROOT/build/classes:$INSTALL_LIB/zimbracommon.jar:$INSTALL_LIB/zimbrastore.jar:$INSTALL_LIB/commons-cli-1.2.jar:$INSTALL_LIB/dom4j-1.5.jar:$INSTALL_LIB/log4j-1.2.8.jar:$INSTALL_LIB/commons-httpclient-3.0.jar:$INSTALL_LIB/commons-logging.jar:$INSTALL_LIB/jaxen-1.1-beta-3.jar:$INSTALL_LIB/ical4j-0.9.16-patched.jar:$INSTALL_LIB/javamail-1.4.3.jar:$INSTALL_LIB/activation.jar:$INSTALL_LIB/commons-codec-1.3.jar"
