...
namespace EASHarness.ActiveSync.HTTP
{
    ...
    class EncodedRequest
    {
        ...
        public EncodedRequest()
        {
            ...
            // TBD: Add the ability to handle locales other than "EN-US"
        ...
        {
            get { return Convert.ToInt32(deviceIdLength); }
        }
        ...
        {
            get { return Convert.ToInt32(policyKeyLength); }
        }
        ...
        {
            get { return Convert.ToInt32(deviceTypeLength); }
        }
        ...
        // This function returns the base64-encoded query value based on the values of the properties of the class.
