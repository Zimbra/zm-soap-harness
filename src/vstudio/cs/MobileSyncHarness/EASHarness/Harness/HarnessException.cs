...
namespace EASHarness.Harness
{
    ...
    public class HarnessException : ApplicationException
    {
        ...
        public HarnessException(string error) : base(error)
        {
            zAssert.AddException(error, this);
            setFirstTestCaseException(this);
        }

        public HarnessException(string error, Exception inner) : base(error, inner)
        {
            zAssert.AddException(error, this);
            setFirstTestCaseException(this);
        }

        protected HarnessException(SerializationInfo info, StreamingContext context): base(info, context) {}
        ...
        // The test case tear down will clean up device instance if this pointer is set
