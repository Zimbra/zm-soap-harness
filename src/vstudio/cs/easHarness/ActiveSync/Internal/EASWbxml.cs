...
namespace Zimbra.EasHarness.ActiveSync
{
    ...
    class EASWbxml
    {
        ...
        private EASWbxmlCodePage[] codePages;
        ...
        public EASWbxml()
        {
            ...
            codePages = new EASWbxmlCodePage[25];

            #region Code Page Initialization
            // Code Page 0: AirSync
            #region AirSync Code Page
            codePages[0] = new EASWbxmlCodePage();
            ...
            codePages[1] = new EASWbxmlCodePage();
            ...
            codePages[1].AddToken(0x07, "AssistnamePhoneNumber");
            ...
            codePages[2] = new EASWbxmlCodePage();
            ...
            codePages[3] = new EASWbxmlCodePage();
            ...
            codePages[4] = new EASWbxmlCodePage();
            ...
            codePages[5] = new EASWbxmlCodePage();
            codePages[5].Namespace = "Move";
            codePages[5].Xmlns = "move";

            codePages[5].AddToken(0x05, "Moves");
            ...
            codePages[6] = new EASWbxmlCodePage();
            ...
            codePages[7] = new EASWbxmlCodePage();
            ...
            codePages[8] = new EASWbxmlCodePage();
            ...
            codePages[9] = new EASWbxmlCodePage();
            ...
            codePages[10] = new EASWbxmlCodePage();
            ...
            codePages[11] = new EASWbxmlCodePage();
            ...
            codePages[12] = new EASWbxmlCodePage();
            ...
            codePages[13] = new EASWbxmlCodePage();
            ...
            codePages[14] = new EASWbxmlCodePage();
            ...
            codePages[15] = new EASWbxmlCodePage();
            ...
            codePages[16] = new EASWbxmlCodePage();
            ...
            codePages[17] = new EASWbxmlCodePage();
            ...
            codePages[18] = new EASWbxmlCodePage();
            ...
            codePages[19] = new EASWbxmlCodePage();
            ...
            codePages[20] = new EASWbxmlCodePage();
            ...
            codePages[21] = new EASWbxmlCodePage();
            ...
            codePages[22] = new EASWbxmlCodePage();
            ...
            codePages[23] = new EASWbxmlCodePage();
            ...
            codePages[24] = new EASWbxmlCodePage();
        ...
        public void LoadBytes(byte[] byteWBXML)
        {
            ...
            EASWbxmlByteQueue bytes = new EASWbxmlByteQueue(byteWBXML);
            ...
            //Temporary comment below code - Prashant 4Nov
            //if (charset != 0x6A)
        ...
        private int GetCodePageByXmlns(string xmlns)
        {
            ...
            // return -1;
            throw new Exception("Unable to get CodePage by xmlns: " + xmlns);
        ...
        private int GetCodePageByNamespace(string nameSpace)
        {
            ...
            // return -1;
            // For POOMCAL try xmlns:POOMCAL='Calendar intead (See CreateApponitment tests as an example)
            //
            throw new Exception("Unable to get CodePage by Namespace: " + nameSpace);
        }
