...
namespace Tests.MailClient.Mail
{
    ...
    public class SmartReplyMail : Tests.BaseTestFixture
    {
        ...
        [Test, Description("Reply to plain text email using SmartReply command"),
        Property("TestSteps", "1. Send email from account1 to EAS user, 2. Reply to this mail(Note: Smart Reply) to Account1, 3. Verify the replied email is in Sent folder, 4. Verify the message is received by the destination, 5. Verify that replied message content is correct i.e. has replied + original content")]
        [Category("Functional")]
        [Category("Mail")]
        [Category("L2")]
        public void SmartReplyMail01()
        {
...
";
        ...
        [Test, Description("Reply to html text email using SmartReply command"),
        Property("TestSteps", "1. Send email from account1 to EAS user, 2. Reply to this mail(Note: Smart Reply) to Account1, 3. Verify the replied email is in Sent folder, 4. Verify the message is received by the destination, 5. Verify that replied message content is correct i.e. has replied + original content")]
        [Category("Functional")]
        [Category("Mail")]
        [Category("L2")]
        public void SmartReplyMail02()
        {
            ...
            String replyContentHtmlEAS = "<html><body>Replied to the <strong>received</strong> email<br><br>----- Reply message -----<br><br></body></html>";
            String replyContentServer = "<html><body><div>Replied to the <strong>received</strong> email<br><br>----- Reply message -----<br><br></div><br><div>This message has html <strong>bold</strong> text</div></body></html>";
            String sentMessageId = "<" + HarnessProperties.getUniqueString() + "@" + TestAccount.DomainName + ">";
...
MIME-Version: 1.0";
            ...
            String mime = MimeBuilder.getHtmlMsgMime(mimeText, plainContent, replyContentHtmlEAS);
...
<Sync xmlns='AirSync' xmlns:AirSyncBase='AirSyncBase' >
    <Collections>
        <Collection>
            ...
            String data = Add.SelectSingleNode("//AirSyncBase:Data", ZAssert.NamespaceManager).InnerText;
            ZAssert.AreEqual(data, replyContentServer, "Verify that content is correct in sent folder");
            ...
            ZAssert.AreEqual(soapContent, replyContentServer, "Verify that content matches in sent and received message");
