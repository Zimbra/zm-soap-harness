...
namespace ExchangeDataTests.Calendar
{
    public class FreeBusyAppointments : BaseTestFixture
    {
        ...
        [Test, Description("Verify a appointment created with showtime as Busy is migrated correctly")]
        ...
        [Test, Description("Verify a appointment created with showtime as Free is migrated correctly")]
        ...
        [Test, Description("Verify a appointment created with showtime as Tentative is migrated correctly")]
