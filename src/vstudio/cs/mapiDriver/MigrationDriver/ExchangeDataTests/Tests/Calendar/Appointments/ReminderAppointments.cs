...
namespace ExchangeDataTests.Calendar
{
    public class ReminderAppointments : BaseTestFixture
    {
        ...
        [Test, Description("Verify a appointment having no reminder set is migrated correctly")]
        [Bug("77428")]
        ...
        [Test, Description("Verify a appointment having default reminder set is migrated correctly")]
        ...
        [Test, Description("Verify a appointment having some reminder set is migrated correctly")]
        ...
        [Test, Description("Verify a all-day appointment having no reminder set is migrated correctly")]
        [Bug("77428")]
        ...
        [Test, Description("Verify a all-day appointment having some reminder set is migrated correctly")]
