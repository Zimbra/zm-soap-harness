...
namespace ExchangeDataTests.Calendar
{
    public class BasicMeetings : BaseTestFixture
    {
        ...
        public void TC3_MeetingWithCategory()
        {
            ...
            #region Test Case variables
            string mtgSubject = "meeting8";
            string mtgContent = "Content8 Meeting with High importance and Category category103";
            DateTime startTimeLocal = new DateTime(2012, 5, 14, 16, 0, 0);
            DateTime endTimeLocal = new DateTime(2012, 5, 14, 16, 30, 0);
            string attendee = "ma2";
            string attendeeRole = "REQ";
        ...
        public void TC7_MeetingMultipleAttendees()
        {
            ...
            TargetAccount.selectSOAP(m, "//mail:rel", "m", defaultReminderMins, null, 1); //reminder is 15 mins
            TargetAccount.selectSOAP(m, "//mail:comp", "fb", "B", null, 1); //fb status of migrated user
            TargetAccount.selectSOAP(m, "//mail:at[@d='" + attendee1 + "']", "ptst", "AC", null, 1); //attendee1 participation status is AC - Accept
            TargetAccount.selectSOAP(m, "//mail:at[@d='" + attendee1 + "']", "role", attendee1Role, null, 1); //attendee1 role is Required
            TargetAccount.selectSOAP(m, "//mail:at[@d='" + attendee2 + "']", "ptst", "TE", null, 1); //attendee2 participation status is TE - Tentative accept
            TargetAccount.selectSOAP(m, "//mail:at[@d='" + attendee2 + "']", "role", attendee2Role, null, 1); //attendee2 role is Optional
            TargetAccount.selectSOAP(m, "//mail:at[@d='" + attendee3 + "']", "ptst", "DE", null, 1); //attendee3 participation status is DE - Decline
        ...
        public void TC8_AllDayMeeting()
        {
            ...
            string mtgContent = "Contect2 All day meeting – reminder 1 hr Ma2 – tentative Ma3 - decline";
            string startTime = "20120330";
            string endTime = "20120330"; 
            string attendee1 = "ma2@zmexch.eng.vmware.com";
            string attendee1Role = "REQ";
            string attendee2 = "ma3@zmexch.eng.vmware.com";
            ...
            TargetAccount.selectSOAP(m, "//mail:at[@a='" + attendee1 + "']", "ptst", "TE", null, 1);
            TargetAccount.selectSOAP(m, "//mail:at[@a='" + attendee1 + "']", "role", attendee1Role, null, 1); //attendee role is Required
            TargetAccount.selectSOAP(m, "//mail:at[@a='" + attendee2 + "']", "ptst", "DE", null, 1);
            TargetAccount.selectSOAP(m, "//mail:at[@a='" + attendee2 + "']", "role", attendee2Role, null, 1); //attendee role is Required
        ...
        public void TC9_MeetingHavingResources()
        {
            ...
            #region Test Case variables
            string mtgSubject = "meeting18";
            string mtgContent = "Content18 Resources - Equipment1 and Room1 Required attendee - ma2";
            DateTime startTimeLocal = new DateTime(2012, 11, 1, 11, 0, 0);
            DateTime endTimeLocal = new DateTime(2012, 11, 1, 12, 0, 0);
            string attendee1 = "ma2";
            string resource1 = "Equipment1";
            string resource2 = "Room1";
            string attendee1Role = "REQ";
            string resource1Role = "NON"; //Non participant role
