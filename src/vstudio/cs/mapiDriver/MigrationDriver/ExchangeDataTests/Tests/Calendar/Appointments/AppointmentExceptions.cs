...
namespace ExchangeDataTests.Calendar
{
    public class AppointmentExceptions : BaseTestFixture
    {
        ...
        [Test, Description("Verify a daily recurring appointment having 2nd occurrence as exception (appointment time and content modified) is migrated correctly")]
        ...
        [Test, Description("Verify a weekly recurring appointment having 1st occurrence as exception (appointment duration and content modified) is migrated correctly")]
