...
namespace PstDataTests.Mail
{
    public class MailSmoke : BaseTestFixture
    {
        ...
        public void MailSmoke01()
        {
            ...
            TargetAccount.selectSOAP(m, "//mail:e", "a", "pstimport2@gmail.com", null, 1);
            TargetAccount.selectSOAP(m, "//mail:e", "a", "pstimport1@gmail.com", null, 1);
        ...
        public void MailSmoke05()
        {
            ...
            TargetAccount.sendSOAP(
                            "<SearchRequest xmlns='urn:zimbraMail' types='message' fetch='1' html='1'>"
                           + "<query> subject:(" + subject + ") in:" + Harness.GlobalProperties.getProperty("globals.sent") + "</query>"
                           + "</SearchRequest>");
