...
namespace NewPSTDataTests.Calendar.Bugs
{
    public class Bug75758 : BaseTestFixture
    {
        public Bug75758()
        {
            this.PstFilename = "/Bugzilla/Bug75758.pst";
        }

        [Test, Description("Migrate pst having recurring meeting with multiple attendees and location, check if all attendees/location get migrated correctly")]
        [Bug("75758")]
        public void Bug75758_01()
        {
            ...
            string attendee1 = "kevin kluge";
            string attendee2 = "Marc";
            string attendee3 = "Ross Dargahi";
            string attendee4 = "Matt Rhoades";
            ...
            TargetAccount.selectSOAP(m, "//mail:comp/mail:at[@d='" + attendee1 + "']", "a", "kevin.kluge@zimbra.com", null, 1);
            TargetAccount.selectSOAP(m, "//mail:comp/mail:at[contains(@d, '" + attendee2 + "')]", "a", "marcmac@zimbra.com", null, 1);
            TargetAccount.selectSOAP(m, "//mail:comp/mail:at[@d='" + attendee3 + "']", "a", "rossd@zimbra.com", null, 1);
            TargetAccount.selectSOAP(m, "//mail:comp/mail:at[@d='" + attendee4 + "']", "a", "matt@zimbra.com", null, 1);
            TargetAccount.selectSOAP(m, "//mail:comp/mail:at[@d='" + attendee5 + "']", "a", "candace@zimbra.com", null, 1);
            TargetAccount.selectSOAP(m, "//mail:comp/mail:at[@d='" + attendee6 + "']", "a", "jrobb@zimbra.com", null, 1);
            TargetAccount.selectSOAP(m, "//mail:comp/mail:at[@d='" + location + "']", "a", "aquafront@zimbra.com", null, 1);
