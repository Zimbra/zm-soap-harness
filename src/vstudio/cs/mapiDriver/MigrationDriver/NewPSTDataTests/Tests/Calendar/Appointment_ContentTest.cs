...
namespace NewPSTDataTests.Calendar
{
    public class Appointment_ContentTest : BaseTestFixture
    {
        ...
        {
            this.PstFilename = "/general/calendar/appt_content.pst";
            Organizer = TargetAccount.emailAddress;
        }

        [Test, Description("Verify a pst having appointment with plain text body is migrated correctly")]
        ...
        [Test, Description("Verify a pst having appointment with html text body is migrated correctly")]
        ...
        [Test, Description("Verify a pst having appointment with pdf attachment is migrated correctly")]
        public void TC3_AppointmentWithPDFAttachment()
        {
            ...
            string apptFragment = "Content20 Appointment with pdf attachment";
        ...
        [Test, Description("Verify a pst having appointment with inline image is migrated correctly")]
        public void TC4_AppointmentWithInlineImage()
        {
            ...
            string apptFragment = "Content19 Mail with png attachment";
