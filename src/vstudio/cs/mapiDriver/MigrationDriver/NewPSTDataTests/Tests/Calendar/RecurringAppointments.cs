...
namespace NewPSTDataTests.Calendar
{
    public class RecurringAppointments : BaseTestFixture
    {
        ...
        {
            this.PstFilename = "/general/calendar/appt_recurring.pst";
            Organizer = TargetAccount.emailAddress;
        }

        [Test, Description("Verify a pst having daily recurring appointment with no end date recurrence pattern is migrated correctly")]
        ...
        [Test, Description("Verify a pst having daily recurring appointment with 5 occurrences recurrence pattern is migrated correctly")]
        ...
        [Test, Description("Verify a pst having weekly recurring appointment with end by date recurrence pattern is migrated correctly")]
        ...
        [Test, Description("Verify a pst having monthly recurring appointment occuring on fixed month date and having end by date recurrence pattern is migrated correctly")]
        ...
        [Test, Description("Verify a pst having monthly recurring appointment occuring on fixed week day and having 3 occurrences is migrated correctly")]
        ...
        [Test, Description("Verify a pst having yearly recurring appointment occuring on fixed month date and having 3 occurrences is migrated correctly")]
        ...
        [Test, Description("Verify a pst having yearly recurring appointment occuring on fixed week-month day and having 2 occurrences is migrated correctly")]
        ...
        [Test, Description("Verify a pst having weekly recurring appointment having category is migrated correctly")]
