...
namespace NewPSTDataTests.Calendar
{
    public class BasicAppointments : BaseTestFixture
    {
        ...
        {
            this.PstFilename = "/general/calendar/appt_basic.pst";
            Organizer = TargetAccount.emailAddress;
        }

        [Test, Description("Verify a pst having basic appointment is migrated correctly")]
        ...
        [Test, Description("Verify a pst having appointment with location is migrated correctly")]
        ...
        [Test, Description("Verify a pst having appointment with category is migrated correctly")]
        ...
        [Test, Description("Verify a pst having private appointment is migrated correctly")]
        ...
        [Test, Description("Verify a pst having all-day appointment is migrated correctly")]
