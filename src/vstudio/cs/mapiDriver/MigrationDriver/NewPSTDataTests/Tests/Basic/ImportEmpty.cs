...
namespace NewPSTDataTests.Basic
{
    public class ImportEmpty : BaseTestFixture
    {
        ...
        [TestSteps("1. Create a new account", "2. Using PST Import tool, import the empty PST file to the account.", "3. Verify using SOAP that the inbox is empty.")]
