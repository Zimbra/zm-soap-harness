...
namespace NewPSTDataTests.Mail
{
    public class MailFunctional : BaseTestFixture
    {
        ...
        public void MailFunctional01()
        {
            ...
            string from = "pstimport2@gmail.com";
            string to = "pstimport1@gmail.com";
            ...
            TargetAccount.selectSOAP("//mail:SearchResponse/mail:m/mail:e[@t='t']", "a", to, null, 1);
        }
        ...
        public void MailFunctional02()
        {
            ...
            string to = "pstimport1@gmail.com";
            string fragment = "this is test mail to check whether the deleted mails gets imported.";
            string subject = "Deleted1";
            #endregion

            TargetAccount.sendSOAP(
                "<SearchRequest xmlns='urn:zimbraMail' types='message' fetch='1'>"
                + "<query> from:(" + sender + ") in:" + GlobalProperties.getProperty("globals.trash") + "</query>"
                + "</SearchRequest>");

            TargetAccount.selectSOAP("//mail:SearchResponse/mail:m/mail:su", null, subject, null, 1);
            TargetAccount.selectSOAP("//mail:SearchResponse/mail:m/mail:fr", null, fragment, null, 1);
            TargetAccount.selectSOAP("//mail:SearchResponse/mail:m/mail:e[@t='f']", "a", sender, null, 1);
            TargetAccount.selectSOAP("//mail:SearchResponse/mail:m/mail:e[@t='t']", "a", to, null, 1);
        }
        ...
        public void MailFunctional03()
        {
            ...
            string sender = "pstimport2@gmail.com";
            string to = "pstimport1@gmail.com";
            string fragment = "This message is to test the message in Rich text format.";
