    ...
    public class MailInject
    {
        ...
        private bool isPostfixQueueEmptySOAP(string mailHost)
        {
            ...
            zAccountAdmin.GlobalAdminAccount.sendSOAP(
                                                    new SoapAdmin.GetMailQueueInfoRequest().
                                                        AddServerName(mailHost)
                                                );
                ...
                while (ienum1.MoveNext())
                {
                    ...
                    if (queueN > 0)
                    {
                        ...
                        do
                        {
                            ...
                            zAccountAdmin.GlobalAdminAccount.sendSOAP(
                                                                            new SoapAdmin.GetMailQueueRequest().
                                                                            AddServer(mailHost, queueName)
                                                                        );
                        ...
                        {
                            zAccountAdmin.GlobalAdminAccount.sendSOAP(
                                                new SoapAdmin.MailQueueActionRequest().
                                                AddServer(mailHost, queueName, SoapAdmin.MailQueueActionRequest.Operations.delete, idList.ToString())
                                            );
