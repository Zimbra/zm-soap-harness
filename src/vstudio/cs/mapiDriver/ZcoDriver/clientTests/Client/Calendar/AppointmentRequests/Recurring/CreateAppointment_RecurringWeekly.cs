...
{
    [TestFixture]
    public class CreateAppointment_RecurringWeekly : BaseTestFixture
    {
        [Test, Description("Verify a recurring weekly appointment is sync from ZCO")]
        [Category("SMOKE"), Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_01()
        {
        ...
        [Test, Description("Verify a weekly recurring all-day appointment request is synced from ZCO ")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_02()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a recurring weekly private appointment is sync from ZCO")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_03()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a weekly recurring private all-day appointment request is synced from ZCO ")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_04()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a recurring weekly appointment with reminder is sync from ZCO")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_05()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a recurring weekly appointment without reminder is sync from ZCO")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_06()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a recurring weekly appointment with reminder modified is sync from ZCO")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_07()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a recurring weekly appointment with enabling reminder after initial sync is sync from ZCO")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_08()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a recurring weekly appointment with disabling reminder after initial sync is sync from ZCO")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_09()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a recurring weekly appointment of duration more than 24 hours is sync from ZCO without any local failures")]
        [Bug("45986")]
        [Category("Calendar")]
        public void CreateAppointment_RecurrenceWeekly_10()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
        ...
        [Test, Description("Verify a recurring weekly appointment is sync from ZCO and the Timezone field is there")]
        [Category("Calendar")]
        [Bug("26344")]
        public void CreateAppointment_RecurrenceWeekly_11()
        {
            initialize(System.Reflection.MethodBase.GetCurrentMethod());
            ...
            zAccount.AccountZCO.selectSOAP(appointmentMessage, "//mail:rule", "freq", "WEE", null, 1);
            zAccount.AccountZCO.selectSOAP(appointmentMessage, "//mail:count", "num", Convert.ToString(recurrencePattern.Occurrences), null, 1);
            zAccount.AccountZCO.selectSOAP(appointmentMessage, "//mail:s", "tz", null, null, 1);
            SoapTest soapTest = new SoapTest();
            DateTime soapStartUTC = soapTest.toUTC(appointmentMessage, "//mail:s");
            zAssert.AreEqual(startTimeLocal.ToUniversalTime(), soapStartUTC, "Verify that the start time (UTC format) is correct");
