...
describe('Admin > Accounts > Modify Account 04', function () {
	...
	let test_account2_name, test_account4_name, test_account5_name, test_account6_name;
	let test_account7_name, test_account8_name, test_account9_name, test_account10_name;
	...
	before(async function () {
		...
		test_account4_name = `test.${Date.now()}.${Math.floor(Math.random() * 1000)}@${config.testDomain}`;
