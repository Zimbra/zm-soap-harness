...
describe('Admin > Accounts > Foreignprincipal > Account Getmembership', function () {
	...
	// Tests
	it('Smoke | GetAccountMembershipRequest by foreignPrincipal - member of one DL', async () => {
	...
	it('Smoke | GetAccountMembershipRequest by foreignPrincipal - nested DL memberships', async () => {
		const response = await soap.makeSOAPEnvelopeAdmin(
			`<GetAccountMembershipRequest xmlns="urn:zimbraAdmin">
	...
	it('Smoke | GetAccountMembershipRequest by foreignPrincipal - not a member of any DL', async () => {
		const response = await soap.makeSOAPEnvelopeAdmin(
			`<GetAccountMembershipRequest xmlns="urn:zimbraAdmin">
