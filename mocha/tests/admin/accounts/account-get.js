...
describe('Admin > Accounts > Account-Get', function () {
    ...
    it('Smoke | GetAccountRequest with valid value of id', async () => {
        ...
        assert.equal(res.GetAccountResponse.account[0].id, testAccountId, 'Account ID should match');
    });
    ...
    it('Smoke | GetAccountRequest with valid value of name', async () => {
        ...
        assert.exists(res.GetAccountResponse, 'Response should exist');
        assert.equal(res.GetAccountResponse.account[0].name, testAccountName, 'Account name should match');
    });
    ...
    it('Regression | GetAccountRequest by id and with invalid applyCos values', async () => {
        ...
        for (const val of invalidValues) {
            ...
            assert.exists(res.GetAccountResponse || res.Fault, `Should handle applyCos="${val}"`);
        }
    });
    ...
    it('Regression | GetAccountRequest by id with leading spaces', async () => {
        ...
        assert.exists(res.GetAccountResponse || res.Fault, 'Should handle leading spaces in id');
    });
    ...
    it('Regression | GetAccountRequest by id with trailing spaces', async () => {
        ...
        assert.exists(res.GetAccountResponse || res.Fault, 'Should handle trailing spaces in id');
    });
    ...
    it('Regression | GetAccountRequest by id with both leading and trailing spaces', async () => {
        ...
        assert.exists(res.GetAccountResponse || res.Fault, 'Should handle leading and trailing spaces');
    });
    ...
    it('Functional | Get account by id of renamed account', async () => {
        ...
        assert.equal(res.GetAccountResponse.account[0].name, newName, 'Should return new name');
    ...
    it('Functional | Get account by new name of renamed account', async () => {
        ...
        assert.equal(res.GetAccountResponse.account[0].id, acctId, 'Should return same account id');
    ...
    it('Regression | GetAccountRequest by id of one account and name of another', async () => {
        ...
        // Should only process first account element
        assert.exists(res.GetAccountResponse, 'Should return response');
        assert.equal(res.GetAccountResponse.account[0].id, testAccountId, 'Should return first account');
