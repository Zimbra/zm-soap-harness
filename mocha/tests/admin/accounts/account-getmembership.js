...
describe('Admin > Accounts > Account Getmembership', function () {
	...
	// Tests
	it('Smoke | Get account membership by id (account is member of DL)', async () => {
	...
	it('Smoke | Get account membership by id (account is NOT a member of any DL)', async () => {
		const response = await soap.makeSOAPEnvelopeAdmin(
			`<GetAccountMembershipRequest xmlns="urn:zimbraAdmin">
	...
	it('Smoke | Get account membership by name (account is member of DL)', async () => {
		const response = await soap.makeSOAPEnvelopeAdmin(
			`<GetAccountMembershipRequest xmlns="urn:zimbraAdmin">
	...
	it('Smoke | Get account membership by name (account is NOT a member of any DL)', async () => {
		const response = await soap.makeSOAPEnvelopeAdmin(
			`<GetAccountMembershipRequest xmlns="urn:zimbraAdmin">
	...
	it('Regression | Get account membership by id with invalid values (blank/space/spchar/sometext/zero/negative)', async () => {
	...
	it('Regression | Get account membership by name with invalid values (blank/space/spchar/sometext/zero/negative)', async () => {
		const invalidValues = ['', '          ', '!@^*()_#%%+', 'thissometexttogetaccountmembershipinvalid', '0000000000000000000000000', '-20238858'];
		for (const val of invalidValues) {
			const response = await soap.makeSOAPEnvelopeAdmin(
				`<GetAccountMembershipRequest xmlns="urn:zimbraAdmin">
	...
	it('Regression | Via-dl-name: account4 -> DL4 -> DL5 (by name)', async () => {
		const response = await soap.makeSOAPEnvelopeAdmin(
			`<GetAccountMembershipRequest xmlns="urn:zimbraAdmin">
	...
	it('Regression | Via-dl-name: account4 -> DL4 -> DL5 (by id)', async () => {
		const response = await soap.makeSOAPEnvelopeAdmin(
			`<GetAccountMembershipRequest xmlns="urn:zimbraAdmin">
	...
	it('Regression | Via-dl-name: account5 -> DL6 -> DL7 -> DL8 (by id and name)', async () => {
		// By ID
