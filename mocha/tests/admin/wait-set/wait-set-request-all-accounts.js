...
describe('Admin > Wait Set > Wait Set Request All Accounts', function () {
	...
	// Tests
	it('Functional | WaitSetRequest with allaccounts attribute (blocking)', async () => {
		...
		// Create a wait set with allaccounts using admin namespace
		...
		const sendRes = await soap.makeSOAPEnvelopeAccount(
			`<SendMsgRequest xmlns="urn:zimbraMail">
				<m>
					...
					<mp ct="text/plain">
						<content>waitset test content</content>
					</mp>
				</m>
		...
		// Send AdminWaitSetRequest to pick up changes
	...
	it('Functional | WaitSetRequest with allaccounts attribute with a new account (non-blocking)', async () => {
