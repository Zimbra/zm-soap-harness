...
describe('Contacts > GAL > GALAccount > Resources > SyncGalRequest', function () {
	...
	// Tests
	it('Sanity | SyncGal resources request', async () => {
	...
	it('Sanity | SyncGal resources incremental sync', async () => {
