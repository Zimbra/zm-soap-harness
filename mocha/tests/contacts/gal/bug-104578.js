...
describe('Contacts > GAL > Bug 104578 - GAL search fix', function () {
	...
	// Tests
	it('Sanity | Bug 104578 SearchGal validation', async () => {
	...
	it('Sanity | Bug 104578 AutoComplete validation', async () => {
		const res = await soap.makeSOAPEnvelopeAccount(
