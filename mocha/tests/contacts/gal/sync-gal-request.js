...
describe('Contacts > GAL > Sync GAL Request', function () {
	...
	// Tests
	it('Sanity | SyncGalRequest initial sync', async () => {
	...
	it('Sanity | SyncGalRequest incremental sync with token', async () => {
	...
	it('Sanity | SyncGalRequest verify response has token', async () => {
		const res = await soap.makeSOAPEnvelopeAccount(
			`<SyncGalRequest xmlns="urn:zimbraAccount"/>`, accountToken
		);
