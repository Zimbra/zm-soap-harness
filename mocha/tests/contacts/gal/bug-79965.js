...
describe('Contacts > GAL > Bug 79965 - GAL search fix', function () {
	...
	// Tests
	it('Sanity | Bug 79965 SearchGal validation', async () => {
	...
	it('Sanity | Bug 79965 AutoComplete validation', async () => {
		const res = await soap.makeSOAPEnvelopeAccount(
