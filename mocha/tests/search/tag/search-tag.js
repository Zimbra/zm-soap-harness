...
describe('Search > Tag > Tag', function () {
	...
	const op = { name: 'op', move: 'move', flag: 'flag', unflag: '!flag', read: 'read', unread: '!read', tag: 'tag', update: 'update', delete: 'delete', trash: 'trash', toString() { return this.name; } };
	...
	const tag3 = { name: `tag3_${common.getUniqueString()}`, subject: `tag3_${common.getUniqueString()}`, from: accountEmail, content: `tag3_${common.getUniqueString()}`, value: `tag3_${common.getUniqueString()}`, address: accountEmail, domainname: config.testDomain, id: `tag3_id`, toString() { return this.name; } };
