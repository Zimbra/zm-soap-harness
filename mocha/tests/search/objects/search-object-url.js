...
describe('Search > Objects > Search Object URL', function () {
...
Content for ${mail3.name}</content>
	...
	it('Functional | Verify that a search for URL is successful (for url in Subject, body, attachment of messages)', async () => {
		// SearchRequest
