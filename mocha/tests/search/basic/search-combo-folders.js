...
describe('Search > Basic > Combo Folders', function () {
	...
	const folder1 = { name: 'foldertext13.01', subject: `folder1_${common.getUniqueString()}`, from: accountEmail, content: `folder1_${common.getUniqueString()}`, value: `folder1_${common.getUniqueString()}`, address: accountEmail, domainname: config.testDomain, id: `folder1_id`, toString() { return this.name; } };
	const folder2 = { name: 'foldertext13.02', subject: `folder2_${common.getUniqueString()}`, from: accountEmail, content: `folder2_${common.getUniqueString()}`, value: `folder2_${common.getUniqueString()}`, address: accountEmail, domainname: config.testDomain, id: `folder2_id`, toString() { return this.name; } };
	const folder3 = { name: 'foldertext13.03', subject: `folder3_${common.getUniqueString()}`, from: accountEmail, content: `folder3_${common.getUniqueString()}`, value: `folder3_${common.getUniqueString()}`, address: accountEmail, domainname: config.testDomain, id: `folder3_id`, toString() { return this.name; } };
	const folder4 = { name: 'foldertext13.04', subject: `folder4_${common.getUniqueString()}`, from: accountEmail, content: `folder4_${common.getUniqueString()}`, value: `folder4_${common.getUniqueString()}`, address: accountEmail, domainname: config.testDomain, id: `folder4_id`, toString() { return this.name; } };
	const folder5 = { name: 'foldertext13.05', subject: `folder5_${common.getUniqueString()}`, from: accountEmail, content: `folder5_${common.getUniqueString()}`, value: `folder5_${common.getUniqueString()}`, address: accountEmail, domainname: config.testDomain, id: `folder5_id`, toString() { return this.name; } };
	const folder6 = { name: 'foldertext13.06', subject: `folder6_${common.getUniqueString()}`, from: accountEmail, content: `folder6_${common.getUniqueString()}`, value: `folder6_${common.getUniqueString()}`, address: accountEmail, domainname: config.testDomain, id: `folder6_id`, toString() { return this.name; } };
