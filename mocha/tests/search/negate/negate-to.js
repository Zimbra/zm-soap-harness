...
describe('Search > Negate > Negate To', function () {
...
Test content</content>
	...
	// Tests
	it('Sanity | Verify that a search for not to - (address) returns the correct email meessage', async () => {
		// SearchRequest
		const res1 = await soap.makeSOAPEnvelopeAccount(
			`<SearchRequest limit="100" xmlns="urn:zimbraMail" types="message">
			   <query>not to:(destination_address)</query>
		...
		const res2 = await soap.makeSOAPEnvelopeAccount(
			`<SearchRequest limit="100" xmlns="urn:zimbraMail" types="message">
			   <query>not to:(destination_address@destination_domain1.destination_domain2.com)</query>
			   </SearchRequest>`, accountAuthToken
		);
	...
	it('Sanity | Verify that a search for -to - (address) returns the correct email meessage', async () => {
		// SearchRequest
		const res1 = await soap.makeSOAPEnvelopeAccount(
			`<SearchRequest limit="100" xmlns="urn:zimbraMail" types="message">
