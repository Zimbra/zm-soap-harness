...
describe('Rest Servlet > Contacts > Basic Csv', function () {
	...
	// Tests
	it('Sanity | Post a Contact CSV to the REST servlet', async () => {
		const csvFilePath = path.join(dataRoot, 'contact1.xls');
