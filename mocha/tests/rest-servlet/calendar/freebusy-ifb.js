...
describe('Rest Servlet > Calendar > Freebusy Ifb', function () {
	...
	before(async function () {
		...
		assert.exists(create3Res.CreateAccountResponse.account[0].id, 'Account ID should exist');
		const host = create3Res.CreateAccountResponse.account[0].a.find(a => a.n === 'zimbraMailHost');
