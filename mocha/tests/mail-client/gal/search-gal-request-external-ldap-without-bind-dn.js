...
describe('Mail Client > GAL > SearchGALRequest_ExternalLDAP_WithoutBindDN', function () {
	...
	it('Sanity | Search an external LDAP GAL for a test account', async () => {
		// Source: SearchGALRequest_ExternalLDAP_WithoutBindDN_01 from GAL/ExternalGAL/SearchGALRequest_ExternalLDAP_WithoutBindDN.xml
