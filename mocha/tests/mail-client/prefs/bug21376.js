...
describe('Mail Client > Prefs > bug21376', function () {
	...
	// Tests
	it('Functional | Verify if the externalmail fetch for IMap folders work properly', async () => {
		// Source: ExternalMailIMapFetch from Prefs/Bugs/bug21376.xml
