...
describe('Folder > Immutable Folders', function () {
    ...
    it('Sanity | Immutable folders cannot be hard deleted', async () => {
        ...
        for (const folderKey of systemFolders) {
            ...
            assert.isTrue(
                faultText.includes('immutable') || faultText.includes('IMMUTABLE'),
    ...
    it('Sanity | Immutable folders cannot be renamed', async () => {
        const systemFolders = ['inbox', 'drafts', 'junk', 'trash', 'sent', 'contacts', 'calendar'];
    ...
    it('Sanity | Immutable folders cannot be moved', async () => {
