...
describe('General > Metadata > Set Custom Metadata Request Basic', function () {
	...
	// Tests
	it('Sanity | Verify basic SetCustomMetadataRequest works for appointment', async () => {
		...
		const setRes = await soap.makeSOAPEnvelopeAccount(
			`<SetCustomMetadataRequest id="${invId}" xmlns="urn:zimbraMail">
				<meta section="${invId}">
				</meta>
	...
	it('Sanity | Verify basic SetCustomMetadataRequest works for mail', async () => {
		// AddMsgRequest
...
simple text string in the body
	...
	it('Sanity | Verify basic SetCustomMetadataRequest works for mail (with multiple metadata)', async () => {
		// AddMsgRequest
		const addRes = await soap.makeSOAPEnvelopeAccount(
			`<AddMsgRequest xmlns="urn:zimbraMail">
				<m l="1">
...
simple text string in the body
	...
	it('Sanity | Verify basic SetCustomMetadataRequest works to clear multiple metadata', async () => {
		// AddMsgRequest
		const addRes = await soap.makeSOAPEnvelopeAccount(
			`<AddMsgRequest xmlns="urn:zimbraMail">
				<m l="1">
