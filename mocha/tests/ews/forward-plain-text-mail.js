...
describe('EWS > Forward Plain Text Mail', function () {
	...
	before(async function () {
		...
		account2Email = `ewsfwdplain2${common.getUniqueString()}@${config.testDomain}`;
		...
		account3Email = `ewsfwdplain3${common.getUniqueString()}@${config.testDomain}`;
	...
	// Tests
	it('Sanity | Send mail with inline attachment from user1 To user2 from ZWC and sync on EWS Then forward same mail to user3 from EWS', async () => {
