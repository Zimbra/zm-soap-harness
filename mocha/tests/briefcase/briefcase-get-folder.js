...
describe('Briefcase > Briefcase Get Folder', function () {
	...
	// Tests
	it('Smoke | Create a briefcase folder. GetFolderRequest to verify the settings', async () => {
		const folderName = 'briefcase1.' + common.getUniqueString();
