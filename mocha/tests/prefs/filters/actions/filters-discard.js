...
describe('Prefs > Filters > Actions > Filters Discard', function () {
	...
	// Tests
	it('Sanity | Create filter rule with discard action', async () => {
				...
				<filterRules>
					<filterRule name="${filterName}" active="1">
						<filterTests condition="anyof">
							<headerTest header="subject" stringComparison="is" value="discardme"/>
						</filterTests>
						<filterActions>
							<actionDiscard/>
						</filterActions>
