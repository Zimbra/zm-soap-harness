...
describe('Prefs > Filters > Actions > Filters Keep', function () {
	...
	// Tests
	it('Sanity | Create filter rule with keep action', async () => {
				...
				<filterRules>
					<filterRule name="${filterName}" active="1">
						<filterTests condition="anyof">
							<headerTest header="subject" stringComparison="is" value="keepme"/>
						</filterTests>
						<filterActions>
							<actionKeep/>
						</filterActions>
