...
describe('Mail > Bugs > Bug 36460', function () {
	...
	// Tests
	it('Functional | Verify bug 36460', async () => {
		// Create the account
...
To: ${accountEmail}
Subject: FROM QUEEN ELIZABETH
MIME-Version: 1.0
Content-Type: text/plain
This is a test message for bug 36460.
</content>
				</m>
