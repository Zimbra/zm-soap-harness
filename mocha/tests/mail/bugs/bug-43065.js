...
describe('Mail > Bugs > Bug 43065', function () {
	...
	// Tests
	it('Functional | Verify bug 43065', async () => {
		// Create the account
		...
		// Add a message with multiple video/x-flv attachments via AddMsgRequest
...
Subject: ${subject}
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="boundary43065"
--boundary43065
Content-Type: text/plain
Test message for bug 43065
--boundary43065
Content-Type: video/x-flv; name="Tulip white bed.jpg"
Content-Disposition: attachment; filename="Tulip white bed.jpg"
Content-Transfer-Encoding: base64
dGVzdA==
--boundary43065
Content-Type: video/x-flv; name="Boat.jpg"
Content-Disposition: attachment; filename="Boat.jpg"
Content-Transfer-Encoding: base64
dGVzdA==
--boundary43065--
</content>
		...
		// Get the message and verify attachment content types
		...
		// Verify multipart structure and attachment types
