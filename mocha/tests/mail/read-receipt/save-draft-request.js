...
describe('Mail > Read Receipt > Save Draft Request', function () {
	...
	// Tests
	it('Smoke | Verify email elment on SaveDraftRequest', async () => {
		...
		// Save draft with read receipt notification element
