...
describe('Mail > LMTP > Verity > LMTP Verity ANSI', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-ANSI', async () => {
		const filePath = path.join(config.data, 'tests/ansi.txt');
