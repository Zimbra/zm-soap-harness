...
describe('Mail > LMTP > Verity > LMTP Verity Corel Word Perfect Windows', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-CorelWordPerfectWindows', async () => {
		const filePath = path.join(config.data, 'tests/corel-wordperfect-windows.txt');
