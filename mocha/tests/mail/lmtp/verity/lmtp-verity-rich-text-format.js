...
describe('Mail > LMTP > Verity > LMTP Verity Rich Text Format', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-RichTextFormat', async () => {
		const filePath = path.join(config.data, 'tests/rich-text-format.txt');
