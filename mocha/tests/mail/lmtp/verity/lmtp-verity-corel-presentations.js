...
describe('Mail > LMTP > Verity > LMTP Verity Corel Presentations', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-CorelPresentations', async () => {
		const filePath = path.join(config.data, 'tests/corel-presentations.txt');
