...
describe('Mail > LMTP > Verity > LMTP Verity Windows Icon Cursor', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-WindowsIconCursor', async () => {
		const filePath = path.join(config.data, 'tests/windows-icon-cursor.txt');
