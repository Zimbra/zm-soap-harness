...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Word Windows DOCX', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftWordWindowsdocx', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-word-windows-docx.txt');
