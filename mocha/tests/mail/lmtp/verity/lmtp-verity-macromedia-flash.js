...
describe('Mail > LMTP > Verity > LMTP Verity Macromedia Flash', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MacromediaFlash', async () => {
		const filePath = path.join(config.data, 'tests/macromedia-flash.txt');
