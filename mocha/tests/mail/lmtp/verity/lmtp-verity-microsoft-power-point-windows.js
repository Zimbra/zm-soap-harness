...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Power Point Windows', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftPowerPointWindows', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-powerpoint-windows.txt');
