...
describe('Mail > LMTP > Verity > LMTP Verity Oasis Open Document', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-OasisOpenDocument', async () => {
		const filePath = path.join(config.data, 'tests/oasis-open-document.txt');
