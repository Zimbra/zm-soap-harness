...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Power Point Windows XML', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftPowerPointWindowsXML', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-powerpoint-windows-xml.txt');
