...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Word XML', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftWordXML', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-word-xml.txt');
