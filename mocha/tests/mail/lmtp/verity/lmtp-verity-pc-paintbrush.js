...
describe('Mail > LMTP > Verity > LMTP Verity Pc Paintbrush', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-PCPaintBrush', async () => {
		const filePath = path.join(config.data, 'tests/pc-paintbrush.txt');
