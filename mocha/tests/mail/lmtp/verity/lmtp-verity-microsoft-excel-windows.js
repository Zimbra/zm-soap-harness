...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Excel Windows', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftExcelWindows', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-excel-windows.txt');
