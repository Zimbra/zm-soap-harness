...
describe('Mail > LMTP > Verity > LMTP Verity Windows Bitmap', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-WindowsBitmap', async () => {
		const filePath = path.join(config.data, 'tests/windows-bitmap.txt');
