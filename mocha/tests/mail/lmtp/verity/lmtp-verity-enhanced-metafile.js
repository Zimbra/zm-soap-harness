...
describe('Mail > LMTP > Verity > LMTP Verity Enhanced Metafile', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-EnhancedMetafile', async () => {
		const filePath = path.join(config.data, 'tests/enhanced-metafile.txt');
