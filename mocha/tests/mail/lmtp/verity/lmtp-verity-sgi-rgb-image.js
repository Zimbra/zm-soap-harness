...
describe('Mail > LMTP > Verity > LMTP Verity SGI RGB Image', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-SGIRGBImage', async () => {
		const filePath = path.join(config.data, 'tests/sgi-rgb-image.txt');
