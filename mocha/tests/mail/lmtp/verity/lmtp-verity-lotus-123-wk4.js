...
describe('Mail > LMTP > Verity > LMTP Verity Lotus 123 Wk4', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-Lotus123wk4', async () => {
		const filePath = path.join(config.data, 'tests/lotus-1-2-3-wk4.txt');
