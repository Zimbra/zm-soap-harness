...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Word Windows', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftWordWindows', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-word-windows.txt');
