...
describe('Mail > LMTP > Verity > LMTP Verity Encapsulated Post Script', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-EncapsulatedPostScript', async () => {
		const filePath = path.join(config.data, 'tests/encapsulated-postscript.txt');
