...
describe('Mail > LMTP > Verity > LMTP Verity Auto CAD Drawing', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-AutoCADDrawing', async () => {
		const filePath = path.join(config.data, 'tests/autocad-drawing.txt');
