...
describe('Mail > LMTP > Verity > LMTP Verity Windows Animated Cursor', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-WindowsAnimatedCursor', async () => {
		const filePath = path.join(config.data, 'tests/windows-animated-cursor.txt');
