...
describe('Mail > LMTP > Verity > LMTP Verity Mac Point', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MacPoint', async () => {
		const filePath = path.join(config.data, 'tests/macpoint.txt');
