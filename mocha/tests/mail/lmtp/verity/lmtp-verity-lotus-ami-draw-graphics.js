...
describe('Mail > LMTP > Verity > LMTP Verity Lotus Ami Draw Graphics', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-LotusAMIDrawGraphics', async () => {
		const filePath = path.join(config.data, 'tests/lotusamidraw-graphics.txt');
