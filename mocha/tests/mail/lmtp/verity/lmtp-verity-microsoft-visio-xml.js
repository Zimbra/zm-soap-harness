...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Visio XML', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftVisioXML', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-visio-xml.txt');
