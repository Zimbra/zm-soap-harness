...
describe('Mail > LMTP > Verity > LMTP Verity Text Mail', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-TextMail', async () => {
		const filePath = path.join(config.data, 'tests/text-mail(mime).txt');
