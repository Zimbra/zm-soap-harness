...
describe('Mail > LMTP > Verity > LMTP Verity Win Zip', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-Winzip', async () => {
		const filePath = path.join(config.data, 'tests/winzip.txt');
