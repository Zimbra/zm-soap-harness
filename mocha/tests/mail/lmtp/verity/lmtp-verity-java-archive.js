...
describe('Mail > LMTP > Verity > LMTP Verity Java Archive', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-JavaArchive', async () => {
		const filePath = path.join(config.data, 'tests/java-archive.txt');
