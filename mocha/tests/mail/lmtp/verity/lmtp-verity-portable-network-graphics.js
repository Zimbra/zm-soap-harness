...
describe('Mail > LMTP > Verity > LMTP Verity Portable Network Graphics', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-PortableNetworkGraphics', async () => {
		const filePath = path.join(config.data, 'tests/portable-network-graphics.txt');
