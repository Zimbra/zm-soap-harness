...
describe('Mail > LMTP > Verity > LMTP Verity True Vision Targa', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-TruevisionTarga', async () => {
		const filePath = path.join(config.data, 'tests/truevision-targa.txt');
