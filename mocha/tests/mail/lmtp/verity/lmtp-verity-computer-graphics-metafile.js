...
describe('Mail > LMTP > Verity > LMTP Verity Computer Graphics Metafile', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-ComputerGraphicsMetafile', async () => {
		const filePath = path.join(config.data, 'tests/computer-graphics-metafile.txt');
