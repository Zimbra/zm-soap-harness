...
describe('Mail > LMTP > Verity > LMTP Verity Tagged Image File', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-TaggedImageFile', async () => {
		const filePath = path.join(config.data, 'tests/tagged-image-file.txt');
