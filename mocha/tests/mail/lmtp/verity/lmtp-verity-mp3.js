...
describe('Mail > LMTP > Verity > LMTP Verity MP3', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MP3', async () => {
		const filePath = path.join(config.data, 'tests/mp3.txt');
