...
describe('Mail > LMTP > Verity > LMTP Verity Open Office Calc SXC', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-OpenOfficeCalcSXC', async () => {
		const filePath = path.join(config.data, 'tests/openoffice-calc-sxc.txt');
