...
describe('Mail > LMTP > Verity > LMTP Verity Macintosh Raster PIC', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MacintoshRasterPIC', async () => {
		const filePath = path.join(config.data, 'tests/macintosh-raster-pic.txt');
