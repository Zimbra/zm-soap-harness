...
describe('Mail > LMTP > Verity > LMTP Verity GIF', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-GIF', async () => {
		const filePath = path.join(config.data, 'tests/gif.txt');
