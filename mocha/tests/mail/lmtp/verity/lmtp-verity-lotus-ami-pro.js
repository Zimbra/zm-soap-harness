...
describe('Mail > LMTP > Verity > LMTP Verity Lotus Ami Pro', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-LotusAMIPro', async () => {
		const filePath = path.join(config.data, 'tests/lotus-ami-pro.txt');
