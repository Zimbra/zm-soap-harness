...
describe('Mail > LMTP > Verity > LMTP Verity Macintosh Raster PCT', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MacintoshRasterPCT', async () => {
		const filePath = path.join(config.data, 'tests/macintosh-raster-pct.txt');
