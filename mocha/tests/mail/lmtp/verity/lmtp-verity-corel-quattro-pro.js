...
describe('Mail > LMTP > Verity > LMTP Verity Corel Quattro Pro', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-CorelQuattroPro', async () => {
		const filePath = path.join(config.data, 'tests/corel-quattro-pro.txt');
