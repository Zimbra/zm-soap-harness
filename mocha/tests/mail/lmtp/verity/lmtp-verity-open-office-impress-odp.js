...
describe('Mail > LMTP > Verity > LMTP Verity Open Office Impress ODP', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-OpenOfficeImpressODP', async () => {
		const filePath = path.join(config.data, 'tests/openoffice-impress-odp.txt');
