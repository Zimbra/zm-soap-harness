...
describe('Mail > LMTP > Verity > LMTP Verity Corel Draw', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-CorelDRAW', async () => {
		const filePath = path.join(config.data, 'tests/coreldraw.txt');
