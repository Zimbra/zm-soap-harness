...
describe('Mail > LMTP > Verity > LMTP Verity Word Perfect Graphics', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-WordPerfectGraphics', async () => {
		const filePath = path.join(config.data, 'tests/wordperfect-graphics.txt');
