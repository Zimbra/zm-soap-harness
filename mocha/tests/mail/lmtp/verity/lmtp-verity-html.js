...
describe('Mail > LMTP > Verity > LMTP Verity HTML', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-HTML', async () => {
		const filePath = path.join(config.data, 'tests/html.txt');
