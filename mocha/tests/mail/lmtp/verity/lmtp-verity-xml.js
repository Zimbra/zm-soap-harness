...
describe('Mail > LMTP > Verity > LMTP Verity XML', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-XML', async () => {
		const filePath = path.join(config.data, 'tests/xml.txt');
