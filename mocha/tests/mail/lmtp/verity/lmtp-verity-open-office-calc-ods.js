...
describe('Mail > LMTP > Verity > LMTP Verity Open Office Calc ODS', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-OpenOfficeCalcODS', async () => {
		const filePath = path.join(config.data, 'tests/openoffice-calc-ods.txt');
