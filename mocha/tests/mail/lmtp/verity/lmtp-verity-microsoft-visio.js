...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Visio', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftVisio', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-visio.txt');
