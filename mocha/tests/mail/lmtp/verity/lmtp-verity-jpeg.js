...
describe('Mail > LMTP > Verity > LMTP Verity JPEG', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-JPEG', async () => {
		const filePath = path.join(config.data, 'tests/jpeg.txt');
