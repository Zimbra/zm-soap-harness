...
describe('Mail > LMTP > Verity > LMTP Verity Comma Separated Values', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-CommaSeparatedValues', async () => {
		const filePath = path.join(config.data, 'tests/comma-separated-values.txt');
