...
describe('Mail > LMTP > Verity > LMTP Verity Adobe PDF', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-AdobePDF', async () => {
		const filePath = path.join(config.data, 'tests/adobe-pdf.txt');
