...
describe('Mail > LMTP > Verity > LMTP Verity Auto CAD Drawing Exchange', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-AutoCADDrawingExchange', async () => {
		const filePath = path.join(config.data, 'tests/autocad-drawing-exchange.txt');
