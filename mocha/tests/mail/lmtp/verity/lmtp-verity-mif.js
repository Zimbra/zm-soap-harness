...
describe('Mail > LMTP > Verity > LMTP Verity MIF', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MIF', async () => {
		const filePath = path.join(config.data, 'tests/mif.txt');
