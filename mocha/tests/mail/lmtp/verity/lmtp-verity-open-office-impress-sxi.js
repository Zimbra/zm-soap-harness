...
describe('Mail > LMTP > Verity > LMTP Verity Open Office Impress SXI', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-OpenOfficeImpressSXI', async () => {
		const filePath = path.join(config.data, 'tests/openoffice-impress-sxi.txt');
