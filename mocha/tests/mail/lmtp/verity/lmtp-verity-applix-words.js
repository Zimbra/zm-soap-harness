...
describe('Mail > LMTP > Verity > LMTP Verity Applix Words', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-ApplixWords', async () => {
		const filePath = path.join(config.data, 'tests/applix-words.txt');
