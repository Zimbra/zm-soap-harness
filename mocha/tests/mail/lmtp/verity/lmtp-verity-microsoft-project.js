...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Project', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftProject', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-project.txt');
