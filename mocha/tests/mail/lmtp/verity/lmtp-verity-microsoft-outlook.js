...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Outlook', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftOutlook', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-outlook.txt');
