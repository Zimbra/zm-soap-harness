...
describe('Mail > LMTP > Verity > LMTP Verity Lotus 123 123', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-Lotus123123', async () => {
		const filePath = path.join(config.data, 'tests/lotus-1-2-3-123.txt');
