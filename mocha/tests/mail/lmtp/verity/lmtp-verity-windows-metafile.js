...
describe('Mail > LMTP > Verity > LMTP Verity Windows Metafile', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-WindowsMetafile', async () => {
		const filePath = path.join(config.data, 'tests/windows-metafile.txt');
