...
describe('Mail > LMTP > Verity > LMTP Verity DCX Fax System', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-DCXFaxSystem', async () => {
		const filePath = path.join(config.data, 'tests/dcx-fax-system.txt');
