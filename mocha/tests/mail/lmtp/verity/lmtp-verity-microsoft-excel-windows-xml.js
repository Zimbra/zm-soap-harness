...
describe('Mail > LMTP > Verity > LMTP Verity Microsoft Excel Windows XML', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-MicrosoftExcelWindowsXML', async () => {
		const filePath = path.join(config.data, 'tests/microsoft-excel-windows-xml.txt');
