...
describe('Mail > LMTP > Verity > LMTP Verity Unicode Text', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-UnicodeText', async () => {
		const filePath = path.join(config.data, 'tests/unicode-text.txt');
