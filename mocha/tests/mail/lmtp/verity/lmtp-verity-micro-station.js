...
describe('Mail > LMTP > Verity > LMTP Verity Micro Station', function () {
	...
	// Tests
	it('Sanity | Inject message and verify indexing/retrieval for Lmtp-Verity-Microstation', async () => {
		const filePath = path.join(config.data, 'tests/microstation.txt');
