...
describe('Mail > LMTP > ISO 8859 1 > LMTP ISO 8859 1', function () {
	...
	// Tests
	it('Functional | Verify bug 15089 - ISO-8859-1 message content should be correctly displayed', async () => {
		// Inject MIME message
		const filePath = path.join(config.data, 'tests/iso88591a.txt');
