...
describe('Mail > LMTP > Large MIME > Large MIME', function () {
	...
	// Tests
	it('Functional | Inject large test mime message 1', async () => {
		// Inject MIME message
		const filePath = path.join(config.data, 'email34/email34a.txt');
	...
	it('Functional | Inject large test mime message 2', async () => {
		// Inject MIME message
		const filePath = path.join(config.data, 'email34/email34b.txt');
		await soap.injectMime(accountAuthToken, filePath);
	...
	it('Functional | Inject large test mime message 3', async () => {
		// Inject MIME message
		const filePath = path.join(config.data, 'email34/email34c.txt');
		await soap.injectMime(accountAuthToken, filePath);
