...
describe('Mail > LMTP > Charsets > UTF 8 > LMTP UTF 8 1', function () {
	...
	// Tests
	it('Functional | Verify Zbug 1022 - UTF-8 subject should be correctly displayed', async () => {
		// Inject MIME message
		const filePath = path.join(config.data, 'tests/utf8a.txt');
