...
describe('Mail > LMTP > OWASP > OWASP MIME', function () {
	...
	// Tests
	it('Smoke | Verify a MIME message with img tag having style attribute', async () => {
		// Inject MIME message
		const filePath = path.join(config.data, 'tests/owasp-7784-message.txt');
