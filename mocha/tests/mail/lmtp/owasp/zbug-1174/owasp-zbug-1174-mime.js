...
describe('Mail > LMTP > OWASP > ZBUG 1174 > OWASP ZBUG 1174 MIME', function () {
	...
	// Tests
	it('Sanity | Verify a MIME message with rgb having percent values', async () => {
		// Inject MIME message
		const filePath = path.join(config.data, 'zbug-1174/zbug-1174-message.txt');
