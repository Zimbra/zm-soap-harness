...
describe('ICAL > Request Reply > Accept 110', function () {
	...
	// Tests
	it('Functional | Verify that TRANSP - OPAQUE is preserved in REPLY', async () => {
		...
		const filePath = path.join(config.projectRoot, 'mocha/data/ical/msg-110.txt');
