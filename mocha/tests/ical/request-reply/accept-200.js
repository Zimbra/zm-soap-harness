...
describe('ICAL > Request Reply > Accept 200', function () {
	...
	// Tests
	it('Functional | Verify VEVENT MUST contain Organizer', async () => {
		...
		const filePath = path.join(config.projectRoot, 'mocha/data/ical/msg-200.txt');
