...
describe('ICAL > Request Reply > Accept 205', function () {
	...
	// Tests
	it('Functional | Verify version is required and it occurs only once', async () => {
		...
		const filePath = path.join(config.projectRoot, 'mocha/data/ical/msg-205.txt');
