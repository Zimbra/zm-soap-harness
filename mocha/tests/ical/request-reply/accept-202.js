...
describe('ICAL > Request Reply > Accept 202', function () {
	...
	// Tests
	it('Functional | Verify the required attributes for VTIMEZONE (BEGIN - STANDARD)', async () => {
		...
		const filePath = path.join(config.projectRoot, 'mocha/data/ical/msg-202.txt');
