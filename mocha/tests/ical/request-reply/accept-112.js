...
describe('ICAL > Request Reply > Accept 112', function () {
	...
	// Tests
	it('Functional | Verify that DTSTART w, o TZID is interpreted as local time', async () => {
		...
		const filePath = path.join(config.projectRoot, 'mocha/data/ical/msg-112.txt');
