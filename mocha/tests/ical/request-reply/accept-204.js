...
describe('ICAL > Request Reply > Accept 204', function () {
	...
	// Tests
	it('Functional | To Verify CALSCALE 0 or 1 (rfc 2446)', async () => {
		...
		const filePath = path.join(config.projectRoot, 'mocha/data/ical/msg-204.txt');
