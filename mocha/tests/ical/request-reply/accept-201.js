...
describe('ICAL > Request Reply > Accept 201', function () {
	...
	// Tests
	it('Functional | Verify in VEVENT attribute ATTENDEE is not compulsary', async () => {
		...
		const filePath = path.join(config.projectRoot, 'mocha/data/ical/msg-201.txt');
