...
The `.agent` directory is professionally organized to provide you with all necessary context:
...
*   **`scripts/`**: Contains utility scripts used for bulk modifications, fixing assertions, fixing tabs, or generating gap analysis reports.
*   **`workflows/`**: Contains exact step-by-step commands you can auto-execute. (e.g., `formatting-rules.md`).
